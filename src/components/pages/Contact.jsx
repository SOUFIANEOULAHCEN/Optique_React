          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <p className="text-gray-700">Route nationale N9 devant le marché quotidien de tarmigt, Ouarzazate, Maroc</p>
              </div>
              <div className="flex items-center">
                <svg
                  className="w-6 h-6 text-emerald-900 mr-4"
                ...
                <p className="text-gray-700">+212 62 377 599</p>
              </div>
              <div className="flex items-center">
                <svg
                  className="w-6 h-6 text-emerald-900 mr-4"
                ...
                <p className="text-gray-700"> nouriaoptique@gmail.com</p>
              </div>
            </div>
          </div>
